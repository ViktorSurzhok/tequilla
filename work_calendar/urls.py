...
from .views import show_calendar, save_work_shift, get_work_shift_form, delete_work_shift, get_employee_bisy
...
urlpatterns = [
    ...
    url(r'^get_employee_bisy/(?P<employee_id>\d+)/$', get_employee_bisy, name='get_employee_bisy'),
